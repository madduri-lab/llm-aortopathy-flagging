...
parser.add_argument("--log_file", type=str, default="clinicalbert-embedding.txt")
parser.add_argument("--embedding_dir", type=str, default="./embedding/clinicalbert")
parser.add_argument("--cluster_file", type=str, default="clinicalbert-7b.pdf")
